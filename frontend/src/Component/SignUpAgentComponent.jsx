...
const Signup = () => {
  const onFinish = values => {
    if (values.password !== values.password2) alert('Passwords are not match!')
    else {
      axios({
        method: 'post',
        url: 'http://127.0.0.1:8000/api/agent/create/',
        headers: {}, 
        data: {
      ...
      <Col span={8}>
          <div style={{ borderRadius: "5px", textAlign: 'center', boxShadow: " 0px 0px 24px 0px rgba(0,48,150,1)", marginBottom: "10px", marginTop: "10px",paddingBottom: "20px", paddingLeft: "15px", backgroundColor: 'white'}}>
            ...
            >
              ...
              >
                <Input placeholder="Email" style={{ width: '250px', marginLeft: "50px" }}/>
              </Form.Item>
              ...
              >
                <Input placeholder="Full name" style={{ width: '250px', marginLeft: "23px" }}/>
              </Form.Item>
              ...
              >
                <Input placeholder="Phone number" style={{ width: '250px', marginLeft: "42px" }}/>
              </Form.Item>
              ...
              <Form.Item
                ...
                name="description"
              >
                <Input.TextArea placeholder="About me" style={{ width: '250px', marginLeft: "30px" }}/>
              </Form.Item>
              ...
              {/* <Form.Item
                ...
                name="photo"
              >
                <Input placeholder="Photo" style={{ width: '250px', marginLeft: "25px" }}/>
              </Form.Item> */}
